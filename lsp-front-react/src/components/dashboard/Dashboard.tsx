...
export default function Dashboard({ children }: { children?: React.ReactNode }) {
  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      constructor() {
        if (!canvas) {
          this.x = 0; this.y = 0; this.size = 1; this.speedX = 0; this.speedY = 0; this.color = 'rgba(255,255,255,0.2)'; return
        }
      ...
      <div className="container mx-auto p-4 relative z-10">
        ...
        <div className="grid grid-cols-12 gap-6">
          <div className="col-span-12 md:col-span-3 lg:col-span-2">
            <Sidebar systemStatus={systemStatus} securityLevel={85} networkStatus={networkStatus} />
          </div>
